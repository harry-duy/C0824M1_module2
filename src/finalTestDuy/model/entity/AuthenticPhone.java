...
public class AuthenticPhone extends Phone {
    ...
    public AuthenticPhone(int id, String name, double price, int quantity,
    ...
    // Getters and setters
    public int getWarrantyTime() { return warrantyTime; }
    public void setWarrantyTime(int warrantyTime) { this.warrantyTime = warrantyTime; }
